...
В доказательствах некоторых теорем этого конспекта используется интересный трюк:
если у нас есть цепочка равенств $a = b$, то мы с лёгкостью сможем продолжить
её, написав $a = b = (a + b) / 2$. Если вы понимаете, что в доказательстве
теоремы с интегралами происходит какая-то дичь, то вспоминайте этот трюк!
...
#proof[
  ...
  И опять применяем теоремы об осцилляции.
]
